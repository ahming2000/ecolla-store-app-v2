...
<header>
    ...
    <a href="https://wa.link/fcfum1" title="通过WhatsApp联系我们！" target="_blank" class="whatsapp-button">
        ...
        <div class="container" id="nav-container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/ch/order-tracking') }}">订单追踪</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-mb-3 col-sm-3">
                    ...
                    <span class="font-color">
                        <i class="icofont icofont-facebook pr-2"></i><a
                            href="https://www.facebook.com/Ecolla-e%E5%8F%A3%E4%B9%90-2347940035424278">e口乐官方脸书</a>
                    </span><br>
                    <span class="font-color">
