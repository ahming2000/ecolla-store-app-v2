    ...
    <main class="container">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{ $item->brand_en }}</li>
                        ...
                        <div class="col-12 slider-control-nav-container mb-3">
                            ...
                            <div class="slider-nav-container">
                                <ul class="slider-nav">
                                    ...
                                    @foreach($item->images as $img)
                                        <li><img class="img-fluid" style="max-height: 100px" src="{{ asset($img->image) }}"/></li>
                                    @endforeach
                            ...
                            @foreach($item->getSortedWholesales() as $w)
                                <div class="h6 wholesale-view" <?= $first ? "" : "hidden"; ?>>
                                    ...
                                    <span class="grey-text">
                                        Purchase until {{ $w->min }} pcs to get wholesale price RM{{ number_format($item->getFirstVariation()->price * $w->rate, 2, '.', '') }}
                                    </span>
                                </div>
                            @endforeach
                        @endif
