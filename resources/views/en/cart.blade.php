                            ...
                            <div class="col-12 mb-3" id="{{ $cartItem->variation->barcode }}">
                                <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-7 col-md-7 col-lg-7 col-xl-7">
                                        ...
                                        <div class="h6 grey-text">{{ $cartItem->variation->name1_en . ' ' . $cartItem->variation->name2_en }}</div>
                                        <!-- Variety property display -->
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-9 d-flex justify-content-center">
                                                ...
                                                <form action="{{ url('/en/cart') }}" method="post">
                                                    ...
                                                    <button type="submit" class="btn btn-primary quantity-increase-button" {{ $cartItem->quantity == $cartItem->variation->getTotalStock() ? "disabled" : "" }}>+</button>
                                                </form>
                                            </div>
