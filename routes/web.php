...
Route::get('/ch/payment-method', [CustomerPageController::class, 'paymentMethod'])->name('ch.payment-method');
...
Route::get('/ch/check-out', [OrdersController::class, 'checkOut'])->name('ch.order.check-out');
Route::post('/ch/check-out', [OrdersController::class, 'store'])->name('ch.order.save');
Route::get('/ch/order-tracking', [OrdersController::class, 'orderTracking'])->name('ch.order.order-tracking');
...
Route::get('/en/payment-method', [CustomerPageController::class, 'paymentMethod'])->name('en.payment-method');
...
Route::get('/en/check-out', [OrdersController::class, 'checkOut'])->name('en.order.check-out');
Route::post('/en/check-out', [OrdersController::class, 'store'])->name('en.order.save');
Route::get('/en/order-tracking', [OrdersController::class, 'orderTracking'])->name('en.order.order-tracking');
